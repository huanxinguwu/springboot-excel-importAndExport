...
/**
 * 是基于excel2003生成的，与excel2007区别仅仅在于两点：
...
public class ExcelWriteTest {
    ...
    public void test01() throws Exception {
        ...
        Sheet sheet=workbook.createSheet("excel2003分数统计表");
        ...
        //将生成的excel文件输出(IO流) 2003版使用xls后缀结尾
        FileOutputStream fileOutputStream = new FileOutputStream("D:/分数统计表.xls");
